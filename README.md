...
**[Update Oct. 20, 2023] We have just released a series of Llama 2 demo apps [here](./demo_apps). These examples show how to run Llama 2 locally and in the cloud to chat about data (PDF, DB, or live) and generate video summary.**
