...
```bash
torchrun --nnodes 1 --nproc_per_node 8  recipes/finetuning/multigpu/fsdp_finetuning.py --enable_fsdp --model_name /patht_of_model_folder/7B --dist_checkpoint_root_folder model_checkpoints --dist_checkpoint_folder fine-tuned --pure_bf16
```
